outputdir<-"H:/shengquanhu/projects/Jennifer/20150130_bojana_HiSeq_FFPE_FF/hiseq/QC3bam/result"
inputfile<-"hiseq_mapping_quality.txt"
outputfile<-"hiseq_mapping_quality.txt.png"
...
g<-ggplot(fp, aes(x=Patient, y=Reads, fill=Mapped))+ geom_bar(stat="identity", width=.5)+
  facet_grid(Type ~ .) +
  ggtitle("HiSeq BAM Quality Control Report") +
