...
setwd("/scratch/cqs/shengq1/breastcancer/final/celllinedataset")
trainingdir<-"/scratch/cqs/shengq1/breastcancer/final/trainingdataset"

readcsv<-0;

#original data
datafile<-"breastcancer_cellline.tsv";
