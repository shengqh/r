...
rsmc<-cur(data, "DNA_RSMC_score")
mutect<-cur(data, "DNA_MUTECT_score")
varscan2<-cur(data, "DNA_VARSCAN2_score")
...
rsmc<-cur(data, "RNA_RSMC_score")
mutect<-cur(data, "RNA_MUTECT_score")
varscan2<-cur(data, "RNA_VARSCAN2_score")
